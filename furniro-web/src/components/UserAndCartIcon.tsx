...
export function UserAndCartIcon({ className }: UserAndCartIconProps) {
    ...
    return (
        ...
        >
            <Link
                to="/login"
                className="flex h-6 w-6 items-center justify-center p-0.1 sm:h-7 sm:w-7"
            ...
            >
                ...
                >
                    {/* Corpo do usuário */}
                    <path
                        d="M9.33333 10.5C12.4483 10.5 18.6667 12.0633 18.6667 15.1667V18.6667H0V15.1667C0 12.0633 6.21833 10.5 9.33333 10.5ZM9.33333 0C10.571 0 11.758 0.491665 12.6332 1.36683C13.5083 2.242 14 3.42899 14 4.66667C14 5.90434 13.5083 7.09133 12.6332 7.9665C11.758 8.84167 10.571 9.33333 9.33333 9.33333C8.09566 9.33333 6.90867 8.84167 6.0335 7.9665C5.15833 7.09133 4.66667 5.90434 4.66667 4.66667C4.66667 3.42899 5.15833 2.242 6.0335 1.36683C6.90867 0.491665 8.09566 0 9.33333 0ZM9.33333 12.7167C5.86833 12.7167 2.21667 14.42 2.21667 15.1667V16.45H16.45V15.1667C16.45 14.42 12.7983 12.7167 9.33333 12.7167ZM9.33333 2.21667C8.68355 2.21667 8.06039 2.47479 7.60092 2.93425C7.14146 3.39372 6.88333 4.01689 6.88333 4.66667C6.88333 5.31645 7.14146 5.93961 7.60092 6.39908C8.06039 6.85854 8.68333 7.11667 9.33333 7.11667C9.98311 7.11667 10.6063 6.85854 11.0657 6.39908C11.5252 5.93961 11.7833 5.31645 11.7833 4.66667C11.7833 4.01689 11.5252 3.39372 11.0657 2.93425C10.6063 2.47479 9.98311 2.21667 9.33333 2.21667Z"
                        fill="black"
                    />

                    {/* Símbolo de exclamação — somente quando deslogado */}
                    {!isAuthenticated && (
                        <path
                            d="M21 9.33333V3.5H23.3333V10.5H21M21 15.1667H23.3333V12.8333H21"
                            fill="black"
                        />
                    )}
                </svg>
            ...
            <CartSidebar
                ...
                className="relative flex h-6 w-6 items-center justify-center p-0.1 sm:h-7 sm:w-7"
            >
                {count > 0 && (
                    <span
                        aria-hidden="true"
