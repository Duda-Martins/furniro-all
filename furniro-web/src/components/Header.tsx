...
export function Header() {
    return (
        <header className="sticky top-0 z-50 h-24 bg-white">
            <Container className="flex h-full flex-row flex-wrap items-center justify-between md:grid md:grid-cols-[1fr_auto_1fr]">
                <Logo />
                <div className="flex flex-row justify-between gap-2 md:contents">
